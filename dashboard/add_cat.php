...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  $name = $_POST['name'];
$sql = "INSERT INTO sectors(sector) VALUES ('$name')";
$con->query($sql);
...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h1 style="text-align: center;">اضافة قطاع</h1>
<hr>
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
      
  <div class="mb-3">
    <label for="name" class="form-label">اسم القطاع :</label>
    <input type="text" required class="form-control" id="name" placeholder="اسم القطاع" name="name">
  </div>
