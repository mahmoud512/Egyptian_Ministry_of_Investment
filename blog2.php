...
?>
        <section class="services-details">
          <div class="container">
            <div class="row">
              <?php
include('inc/dsing/blog2/aksam_aktchf.php');

if (isset($_GET['ac1'])) {
  include('inc/dsing/blog2/actchf1.php');
}elseif(isset($_GET['ac2'])){
  include('inc/dsing/blog2/actchf2.php');
}elseif(isset($_GET['ac3'])){
  include('inc/dsing/blog2/actchf3.php');
}elseif(isset($_GET['ac4'])){
  include('inc/dsing/blog2/actchf4.php');
}
?>
